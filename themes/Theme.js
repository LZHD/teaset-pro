...
const Theme = {
  ...
  get screenInset() {
    ...
    let _isIPhoneX = this.isIPhoneX;
    let fitIPhoneX = this.fitIPhoneX;
    return {
      left: isLandscape && _isIPhoneX && fitIPhoneX ? 44 : 0,
      right: isLandscape && _isIPhoneX && fitIPhoneX ? 44 : 0,
      top: this.statusBarHeight,
      bottom: _isIPhoneX && fitIPhoneX ? (isLandscape ? 24 : 34) : 0,
    };
  },
};
